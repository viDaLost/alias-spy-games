...
export async function openApp(browser, baseURL, { scale = 3, stars = 20, extraRoutes } = {}) {
  ...
  await context.addInitScript(() => {
    ...
    try {
      ...
      const games = ['bible-wow', 'quartet', 'biblical-match-three', 'moses-nile', 'twelve-tribes', 'promised-land', 'bible-sketch', 'guess', 'alias', 'coimaginarium', 'describe', 'spy', 'bible-wordsearch', 'sacred-word', 'kids-ark-pairs', 'kingdoms'];
