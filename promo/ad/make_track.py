"""
Музыка для рекламного ролика: тёплый поп-хаус 120 BPM, ровно 7 тактов (14 с),
петлёй. Написана здесь же, поэтому права на неё целиком у владельца
приложения — никаких чужих сэмплов и лицензий.

Гармония — фа мажор, по аккорду на такт: F · C · Dm · Bb · F · C · Bb(sus) и
снова F в начале петли. Маримба играет восьмыми, под ней мягкий пэд и бас на
слабых восьмых; хлопки на 2 и 4. Акценты (аккорд с колокольчиком) стоят на
долях, где в кадре главное событие сцены: слово легло в кроссворд, собран
квартет, три «Библии» исчезли, корзинка нырнула под заросли и перепрыгнула
бревно, финал.
...
свёртка через FFT). Конец петли переходит в её начало без шва.
    ...
    python3 promo/ad/make_track.py  →  promo/ad/build/music.wav
"""
import os
import wave
...
# Доли (с нуля), где в кадре главное событие сцены — см. раскадровку в README.
ACCENTS = {6: 0.8, 7: 0.55, 15: 0.9, 18: 0.8, 19: 0.6, 21: 0.5, 23: 0.8, 24: 1.0}
...
# Аккорды по тактам (корень баса, голоса пэда, ноты арпеджио маримбы).
CHORDS = [
    ('F', [('F', 3), ('A', 3), ('C', 4), ('E', 4)], [('F', 4), ('A', 4), ('C', 5), ('A', 4), ('F', 5), ('C', 5), ('A', 4), ('C', 5)]),
    ('C', [('E', 3), ('G', 3), ('C', 4), ('D', 4)], [('C', 5), ('E', 5), ('G', 4), ('E', 5), ('C', 5), ('G', 5), ('E', 5), ('D', 5)]),
    ('D', [('F', 3), ('A', 3), ('D', 4), ('E', 4)], [('D', 5), ('F', 5), ('A', 4), ('F', 5), ('D', 5), ('A', 5), ('F', 5), ('E', 5)]),
    ('Bb', [('F', 3), ('Bb', 3), ('D', 4), ('F', 4)], [('Bb', 4), ('D', 5), ('F', 5), ('D', 5), ('Bb', 4), ('F', 5), ('D', 5), ('C', 5)]),
    ('F', [('F', 3), ('A', 3), ('C', 4), ('E', 4)], [('F', 4), ('A', 4), ('C', 5), ('A', 4), ('F', 5), ('C', 5), ('A', 4), ('C', 5)]),
    ('C', [('E', 3), ('G', 3), ('C', 4), ('D', 4)], [('C', 5), ('E', 5), ('G', 4), ('E', 5), ('C', 5), ('G', 5), ('E', 5), ('D', 5)]),
    ('Bb', [('F', 3), ('Bb', 3), ('C', 4), ('F', 4)], [('Bb', 4), ('D', 5), ('F', 5), ('D', 5), ('C', 5), ('F', 5), ('G', 5), ('A', 5)]),
]
...
def main():
    ...
    for s in range(4):
        place(drums, shaker(0.014, 0.6 + 0.15 * s), 27 + s * 0.25, 1.8)
