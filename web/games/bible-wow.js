...
function startBibleWowGame(levelsUrl) {
  ...
  */
  ...
  function checkWord(wordRaw) {
    ...
    showMsg("Такого слова нет в Библии");
  }
  ...
  */
  function giveHint() {
    ...
    if (!candidates.size) { showMsg("Все буквы уже открыты — наберите слово"); return; }
  ...
  function revealWordPaid() {
    ...
    if (!closed.length) { showMsg("Все буквы уже открыты — наберите слово"); return; }
