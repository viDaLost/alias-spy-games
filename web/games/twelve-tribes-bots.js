...
// забывает затрубить в шофар. Это не слабость, а условие: соперник, который
// никогда не забывает, отнимает у правила «поймай соседа» всякий смысл, а
...
(function () {
  ...
  */
  ...
  /*
    Забывчивость. «Отрок» трубит в шофар в трёх случаях из четырёх, а
  ...
  */
  ...
  /** Ловит ли бот соседа, забывшего затрубить. Отрок замечает не всегда. */
