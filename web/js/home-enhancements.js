(() => {
  const GAMES = {
    ...
    'Соглядатай': { key: 'spy', desc: 'Секретная роль и локация', icon: 'spy' },
    // Прежнее название игры: в истории последних игр у людей записано оно.
    ...
    'Библейские сокровища': { key: 'biblical-match-three', desc: 'Комбинации, бустеры и путь из 50 уровней', icon: 'matchThree' },
