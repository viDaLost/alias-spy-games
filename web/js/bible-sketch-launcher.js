(() => {
  ...
  function loadGameScript() {
    ...
    gameScriptPromise = new Promise((resolve, reject) => {
      ...
      script.src = `${window.AppLanguage?.asset?.('web/games/bible-sketch.js') || 'web/games/bible-sketch.js'}?v=4`;
