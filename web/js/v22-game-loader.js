(() => {
  'use strict';
  const GUARD = 'web/js/v22-legacy-tutorial-guard.js?v=28';
  const POLISH = 'web/js/v22-game-polish.js?v=28';
  const V23 = 'web/js/v23-biblical-treasures-polish.js?v=28';
  let loading = false;
  ...
  async function load() {
    ...
    try {
      ...
      console.error('[Biblical Treasures V28]', error);
    } finally {
      loading = false;
    }
  }
