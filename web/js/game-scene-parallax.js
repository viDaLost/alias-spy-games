/*
  ...
  Обе темы. Арт ночной, и в лоб он годится только тёмной. В светлой он не
  выброшен, а переосмыслен стилями: слои высветляются и обесцвечиваются, а
  поверх ложится прежний светлый градиент экрана игры, но с прозрачностью —
  картина проступает подмалёвком, а тёмный текст и белые карточки читаются как
  читались. Всё это в game-scene-parallax.css; сюда тема не заглядывает вовсе.
