(() => {
      ...
      blocks: [
        {
          ...
          text: 'Пять царств в условном мире, вдохновлённом библейскими землями, спорят за '
            + 'двадцать четыре области. Правила — настольной «Битвы за Рокуган»: пять раундов, в '
            + 'каждом вы по очереди кладёте жетоны рубашкой вверх, затем все они открываются и '
            + 'исполняются разом. Побеждает тот, у кого в конце больше очков чести.',
          note: 'От 2 до 5 участников: против компьютера и по сети. События партии — не пересказ '
            + 'Писания: мир условный, библейские в нём облик и имена.',
        },
        {
          title: 'Расстановка и тайная цель',
          text: 'Каждое царство начинает со своей столицы. Затем, начиная с первого игрока, все по '
            + 'очереди ставят жетоны контроля в свободные области — на двоих по три, на троих по три, '
            + 'на четверых и пятерых по два. Каждому раздают две тайные цели; вы оставляете одну.',
        },
        {
          title: 'Карта',
          text: 'Двадцать четыре области в шести регионах. Число на области — её честь в итоговом '
            + 'счёте. Прибрежные области — у моря вдоль севера и у реки: их атакуют корабли с воды. '
            + 'Два брода связывают срединные области через реку.',
          table: {
            head: ['Регион', 'Местность', 'Награда за весь регион'],
            rows: [
              ['Приморье', 'побережье', '«Дары моря»: +2 к чести в Тарсийской Гавани'],
              ['Нагорье', 'горы', '«Горная твердыня»: +2 к защите в Крепости Ора'],
              ['Долина Йора', 'равнина', '«Жертвенник у брода»: Йорский Брод нельзя атаковать'],
              ['Срединная равнина', 'равнина', '«Житницы»: +2 к чести в Житницах'],
              ['Пустошь Кедем', 'пустыня', '«Колодцы пустыни»: ещё одна карта «Пророк»'],
              ['Порубежье', 'горы и пустыня', '«Твердыня рубежа»: +2 к защите в Пограничной Твердыне'],
            ],
          },
          note: 'Награду региона получает первый, кто возьмёт его целиком, — один раз за партию.',
        },
        {
          title: 'Пять царств: способность и особый жетон',
          table: {
            head: ['Царство', 'Способность', 'Особый жетон'],
            rows: [
              ['Тарсийский Союз', '«Корабли Тарсиса»: +1 к силе каждого своего жетона «Корабли».', '«Флагман» — корабли силой 3.'],
              ['Дом Ора', '«Горная стража»: +1 к защите своих горных областей.', '«Благословение гор» — +3 к своему жетону битвы.'],
              ['Дом Йора', '«Мастера переправ»: +1 к силе войска, атакующего через брод.', '«Засада у брода» — засада силой 3.'],
              ['Престол Равнины', '«Зодчие»: +1 к защите своих городов.', '«Колесницы» — войско силой 6.'],
              ['Кочевники Кедема', '«Соглядатаи пустыни»: три карты «Соглядатаи» вместо двух.', '«Набег всадников» — поджог без соседства.'],
            ],
          },
          note: 'Царство выбирают перед партией, как клан в «Битве за Рокуган»; по сети — одно царство на человека. Особый жетон лежит в запасе сверх общих двадцати пяти.',
        },
        {
          title: 'Раунд',
          list: [
            '<b>Перегруппировка</b> — пустой жетон возвращается за ширму, остальные добираются из запаса до шести; первый игрок меняется по кругу.',
            '<b>Размещение</b> — по очереди, по одному жетону рубашкой вверх, пока у каждого не останется один: он переходит в следующий раунд.',
            '<b>Исполнение</b> — всё открывается; пустые жетоны возвращаются; затем поджоги, заветы мира и все сражения разом.',
          ],
          note: 'На одну границу — один жетон, чей бы он ни был; в центр своей области защитных '
            + 'жетонов — сколько угодно. Соперники видят, где лежит ваш жетон, но не его вид и силу.',
        },
        {
          title: 'Жетоны битвы',
          table: {
            head: ['Жетон', 'Как действует'],
            rows: [
              ['Войско 1–5', 'На границе своей области — атака соседней; в центре своей — оборона.'],
              ['Корабли 1–2', 'С воды — атака прибрежной области из любого места; в центре своей прибрежной — оборона.'],
              ['Засада 1–2', 'В центр любой области: в чужой нападает, в своей защищает.'],
              ['Благословение +1/+2', 'Открыто поверх своего войска, кораблей или засады: прибавляет силу и хранит жетон от карт.'],
              ['Завет мира', 'В своей области: навсегда мир — её нельзя атаковать, из неё нельзя атаковать.'],
              ['Поджог', 'В чужой или ничьей области рядом с вашей (или где ваша засада): вечное пепелище.'],
              ['Отвлекающий манёвр', 'Пустой: кладётся как любой, в бою не участвует и возвращается в руку.'],
            ],
          },
          note: 'В запасе у каждого одинаково: войска 1×4, 2×4, 3×3, 4×2, 5×1, корабли 1×2 и 2×1, '
            + 'засады 1 и 2, благословения +1 и +2, два завета мира, два поджога — и пустой жетон.',
        },
        {
          title: 'Карты',
          table: {
            head: ['Карта', 'Действие'],
            rows: [
              ['Соглядатаи (две)', 'В начале хода: посмотреть один чужой закрытый жетон — видите только вы.'],
              ['Пророк (один)', 'В начале хода: открыть всем один чужой закрытый жетон и сбросить его.'],
              ['Право первенства', 'У первого игрока раунда (кроме игры вдвоём): вернуть один закрытый жетон любого игрока в его запас.'],
            ],
          },
          note: 'Карты ход не заканчивают и уходят из партии после игры. Благословлённый жетон им неподвластен.',
        },
        {
          title: 'Сражение и защита',
          text: 'Атакующие одной области складывают силу своих жетонов; защитник — силу своих '
            + 'защитных жетонов и бонусы: столица +2, другой город +1, горы +1, по +1 за каждый '
            + 'открытый жетон контроля, особый жетон «+2 к защите», способность царства. Побеждает '
            + 'наибольшая сила; <b>при любой ничьей наверху побеждает защитник</b>.',
          note: 'Победитель-атакующий забирает область. Устоявший защитник — и тот, кто просто '
            + 'стоял на страже, — кладёт открытый жетон контроля: +1 к защите и +1 очко. У ничьей '
            + 'области нет ничего, кроме напечатанных бонусов: пустую равнину берёт войско силой 1. '
            + 'Кто потерял все области, становится изгнанником и ставит войска на любые границы.',
        },
        {
          title: 'Победа',
          text: 'После пятого раунда: честь ваших областей, по очку за каждый открытый жетон '
            + 'контроля, +5 за каждый регион целиком (пепелища в регионе не мешают) и очки тайной цели.',
          table: {
            head: ['Тайная цель', 'Очки'],
            rows: [
              ['Хранитель столицы — удержать свою столицу', '3'],
              ['Собиратель земель — 5 связных областей', '4'],
              ['Мастер переправы — оба берега одного брода', '4'],
              ['Собиратель городов — три города', '5'],
              ['Властитель вод — три прибрежные области', '4'],
              ['Хозяин гор — три горные области', '4'],
              ['Путь через пустыню — три пустынные области', '4'],
              ['Сердце земли — три срединные области', '5'],
              ['Миротворец — две области под заветом мира', '4'],
              ['Стойкость — три открытых жетона контроля', '4'],
            ],
          },
          note: 'При равенстве очков побеждает тот, у кого больше регионов, затем — областей; иначе победа общая.',
        },
      ],
    },
  ];
  ...
  */
  ...
  // kd-tester ставит app.js тем, кому «Царства» открыты до выпуска.
  const isOwner = () => ['admin-rbac-root', 'kd-tester'].some((name) => document.documentElement.classList.contains(name));
