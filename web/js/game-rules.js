      ...
      blocks: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ['Приморье', 'побережье', '«Дары моря»: +2 к чести в Тире'],
              ['Гора Сеир', 'горы', '«Горная твердыня»: +2 к защите в Восоре'],
              ['Долина Иордана', 'равнина', '«Жертвенник у брода»: Броды Иордана нельзя атаковать'],
              ['Земля Сеннаар', 'равнина', '«Житницы»: +2 к чести в Житницах'],
              ['Аравия', 'пустыня', '«Колодцы пустыни»: ещё одна карта «Пророк»'],
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ['Фарсис', '«Фарсисские корабли»: +1 к силе каждого своего жетона «Корабли».', '«Флагман» — корабли силой 3.'],
              ['Едом', '«Горная стража»: +1 к защите своих горных областей.', '«Благословение гор» — +3 к своему жетону битвы.'],
              ['Галаад', '«Мастера переправ»: +1 к силе войска, атакующего через брод.', '«Засада у брода» — засада силой 3.'],
              ['Сеннаар', '«Зодчие»: +1 к защите своих городов.', '«Колесницы» — войско силой 6.'],
              ['Кидар', '«Соглядатаи пустыни»: три карты «Соглядатаи» вместо двух.', '«Набег всадников» — поджог без соседства.'],
            ],
          },
