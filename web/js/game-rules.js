  ...
  const GAMES = [
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['<b>Странствие +2</b>', 'Сосед берёт две карты и пропускает ход', '8'],
              ['<b>Жребий колен</b>', 'Кладётся на что угодно, вы называете стан', '4'],
              ['<b>Плен +4</b>', 'Вы называете стан, сосед берёт четыре и пропускает ход', '4'],
            ],
          },
        ...
        {
          title: 'Счёт',
          text: 'Раздачу берёт тот, кто первым остался без карт. В партии до трёхсот очков победитель '
            + 'раздачи забирает себе стоимость карт, оставшихся на руках у остальных: жребий стоит '
            + 'своего числа, любое действие — двадцать, жребий колен и плен — по пятьдесят.',
          note: 'Отсюда и осторожность с сильными картами: плен, доживший до конца раздачи, стоит '
            + 'пятьдесят очков — вашему сопернику.',
        },
      ],
    },
    {
