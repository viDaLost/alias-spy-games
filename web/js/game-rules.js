      ...
      blocks: [
        {
          ...
          text: 'Телефон передаётся по кругу: каждый смотрит свою карточку так, чтобы не видели остальные. '
            + 'Все, кроме шпионов, знают локацию; шпионы не знают ничего.',
          list: [
            'От 3 до 20 игроков, шпионов всегда меньше, чем игроков.',
            'Дальше — разговор: задавайте вопросы так, чтобы свои поняли, а шпион нет.',
            'Голосованием ищут шпиона, шпион пытается угадать локацию.',
          ],
        },
      ],
    },
