      ...
      blocks: [
        ...
        },
        {
          ...
          text: 'Встали на свободный удел — можете купить. Встали на чужой — платите хозяину, '
            + 'и тем больше, чем он обжит. Обживать удел можно, только собрав все уделы его '
            + 'цвета, и строить нужно вровень — пять ступеней одна за другой:',
          table: {
          ...
          note: 'Жертвенник — главный выбор игры: брать деньгами или очками.',
        },
        {
