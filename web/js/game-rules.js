      ...
      blocks: [
        {
          ...
          note: 'Играется вдвоём, втроём или вчетвером: один человек и от одного до трёх соперников от игры.',
        },
        {
          title: 'Четыре стана — четыре масти',
          text: 'Израиль в пустыне стоял не толпой: вокруг скинии стояли четыре стана, по три колена '
            + 'в каждом, и у каждого была своя сторона света (Числа 2:3–31). Эти четыре стана и есть '
            + 'масти колоды.',
          table: {
          ...
          note: 'Стороны света и колена — из книги Чисел. Знаки станов (лев, человек, телец, орёл) — '
            + 'предание, а не Писание; в игре они нужны ещё и затем, чтобы масть узнавалась не только '
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['<b>Странствие</b>', 'Сосед берёт две карты и пропускает ход', '8'],
              ['<b>Жребий колен</b>', 'Кладётся на что угодно, вы называете стан', '4'],
              ['<b>Плен</b>', 'Вы называете стан, сосед берёт четыре и пропускает ход', '4'],
            ],
          },
          note: 'Плен кладут только тогда, когда в руке нет ни одной карты нынешнего стана. Иначе эта '
            + 'карта превращалась бы в «выиграть, ничего не решая».',
        },
        {
          title: 'Шофар',
          text: 'Оставшись с <b>одной картой</b>, затрубите в шофар — нажмите кнопку. Забыли, и соперник '
            + 'это заметил, — берёте две карты. Поймать можно, только пока следующий игрок не сделал '
            + 'свой ход; соперники от игры тоже иногда забывают трубить, и поймать их можно тем же '
            + 'нажатием.',
          note: 'Взяли карты после объявления — объявление больше не в силе: шофар говорит про сейчас.',
        },
        {
          title: 'Счёт',
