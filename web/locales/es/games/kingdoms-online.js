...
(function () {
  ...
  class Online {
    ...
    paintStatus() {
      ...
      if (!box) return;
      const words = {
        connecting: 'Conectando…', reconnect: 'Связь потеряна, восстанавливаем…',
