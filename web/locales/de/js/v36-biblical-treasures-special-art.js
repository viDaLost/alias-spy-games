(() => {
  ...
  const LABELS = {
    lineH: 'Horizontaler Verstärker',
    lineV: 'Vertikaler Verstärker',
    burst: 'Explosionsverstärker',
    rainbow: 'Regenbogenverstärker',
  };
  ...
  function patchTile(tile) {
    ...
    const label = LABELS[special] || 'Spezialverstärker';
