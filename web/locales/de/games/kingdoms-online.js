...
(function () {
  ...
  class Online {
    ...
    paintStatus() {
      ...
      if (!box) return;
      const words = {
        connecting: 'Verbindung wird hergestellt…', reconnect: 'Связь потеряна, восстанавливаем…',
