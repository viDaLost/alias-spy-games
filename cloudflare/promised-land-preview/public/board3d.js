    ...
    function stats() {
      ...
      return {
        ...
        */
        ...
        zoom: view.zoom,
        // Сколько анимаций ещё идёт (полёт карты, кости, шаги): проверке
        // незачем гадать паузой, долетела ли карта, — она ждёт нуля.
        moving: jobs.length,
        // Лежит ли на столе карта из колоды (вылетела и ещё не принята).
        card: Boolean(flying),
      };
    }
