  ...
  function steps({ scene, art, mode }) {
    ...
    return [
      ...
      },
      {
        cell: cheap.n,
        title: 'Чей это удел',
        text: 'Как только удел куплен, вдоль нижнего края карточки ложится цветная плашка '
          + 'с именем хозяина — прямо на поле, там же, где имя удела и цена. Ваша читается '
          + '«Вы». По ней сразу видно, на чью землю вы идёте и кому платить.',
      },
      {
        cell: cheap.n,
        title: 'Поселение',
