...
window.PromisedLandTutorial = (() => {
  ...
  function steps({ scene, art, mode }) {
    ...
    return [
      ...
      {
        title: 'Наследие',
        text: 'В конце считают не серебро, а наследие: каждая построенная ступень, каждый '
          + 'жертвенник, каждые сто сиклей десятины и каждый выкупленный из наёма. Поэтому '
