...
for (const token of ['startSpyOnlineGame', 'createVoiceChat', 'RTCPeerConnection', 'getUserMedia', '__spyOnlineCleanup', 'spy-backend']) {
...
for (const token of ['relaySignal', 'signalQueues', 'drainSignals', 'buildView', 'DurableObject', 'verifySessionToken', 'ROOM_IDLE_TTL_MS']) {
...
console.log(`OK: онлайн-Шпион — режимы на месте, ${LOCATIONS.length} локаций совпадают, секреты не утекают.`);
