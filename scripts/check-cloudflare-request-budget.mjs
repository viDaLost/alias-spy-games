...
assert(html.includes('bmt-stars-cloud-sync.js?v=49'), 'BMT request-budget cache key must be fresh');
...
assert(html.includes('network-warmup.js?v=2'), 'network warmup cache key must be fresh');
