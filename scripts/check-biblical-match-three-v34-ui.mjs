...
try {
  ...
  await page.waitForFunction(()=>document.querySelector('.bmt-result-card')?.dataset.v34ResultSynced==='3',{timeout:5000});
  // The V31 bug starved timers forever after a win. This proves the event loop settles.
  await page.waitForFunction(()=>window.__qaTimerFired===true,{timeout:2500});
