...
// After AndroidSessionStore contains a verified encrypted session, 3.0.6 serves
...
need(gradle, 'versionCode 33', 'Android versionCode is not current');
need(gradle, "versionName '3.0.6-standalone'", 'Android version is not current');

console.log('Android 3.0.6 verified-session access, standalone appassets Web runtime and ban refresh checks passed.');
