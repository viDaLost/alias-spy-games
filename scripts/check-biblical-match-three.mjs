...
ok(indexHtml.includes('biblical-match-three-launcher.js?v=42') && indexHtml.includes('system-icons.js?v=22') && indexHtml.includes('android-download-menu.js?v=23') && indexHtml.includes('room-qr-addon.js?v=4'), 'current cache bust wiring missing');
