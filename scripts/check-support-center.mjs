...
requireText(gradle, "versionCode 31", 'Android release versionCode is not current');
requireText(gradle, "versionName '3.0.4-standalone'", 'Android release version is not current');
