...
requireText(gradle, "versionCode 34", 'Android release versionCode is not current');
requireText(gradle, "versionName '3.0.7-standalone'", 'Android release version is not current');
...
if (parityShell.includes('WEB_APP_ORIGIN = "vidalost.github.io"')) throw new Error('Android parity shell still impersonates the GitHub Pages origin');
...
console.log('Support center integration checks passed through the Core v14 RBAC chain and Android 3.0.7 standalone appassets runtime.');
