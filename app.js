...
function openSupport() {
  ...
  container.innerHTML = `
    ...
    <p>Нажмите на три точки с права в верхнем углу, потом надмите Обновить страницу. Если проблема не решилась — нажмите на кнопку ниже и опишите свою проблему.</p>
