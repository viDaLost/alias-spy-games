...
enum class GameKey(
    ...
    QUARTET("quartet", "Квартет", "Собери четыре связанные карты", "assets/icons/quartet.png", GameSection.COMPANY, 0xFF0F766E),
    ...
    PAIRS("kids-ark-pairs", "Найди пару", "Соберите животных попарно", "assets/icons/ark.png", GameSection.KIDS, 0xFF059669),
    MATCH_THREE("biblical-match-three", "Библейские сокровища", "Комбинации, бустеры и путь из 30 уровней", "assets/icons/biblical-treasures-v38.png", GameSection.KIDS, 0xFF4F46E5),
    SKETCH("bible-sketch", "Библейский художник", "Рисуйте по очереди и найдите шпиона", "assets/icons/bible-sketch.webp", GameSection.COMPANY, 0xFFDB2777),
    ;
