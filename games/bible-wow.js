...
function startBibleWowGame(levelsUrl) {
  ...
  style.textContent = `
    ...
    .wow-grid{display:grid;justify-content:center;--gap:6px;gap:var(--gap);--cols:10;--cell:calc((min(92vw, 460px) - (var(--cols) - 1)*var(--gap))/var(--cols));}
    .wow-cell{width:var(--cell);height:var(--cell);border-radius:10px;display:flex;align-items:center;justify-content:center;
