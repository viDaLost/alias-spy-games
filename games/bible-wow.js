...
function startBibleWowGame(levelsUrl) {
  ...
  function renderSkeleton() {
      ...
      <div class="wow-wrap">
        <div class="wow-top">
          <div class="wow-topBtns">
            ...
            <button class="wow-iconBtn" id="wow-levelsBtn" title="Список уровней">≡</button>
          </div>
          ...
          <div class="wow-pill">
            ...
            <button class="wow-chip" id="wow-bonusBtn" style="cursor:pointer;">⭐ Бонусные</button>
    ...
    document.getElementById("wow-levelsBtn")?.addEventListener("click", () => { renderLevelsList(); openModal(levelsModal); });
    ...
    document.getElementById("wow-bonusBtn")?.addEventListener("click", () => { renderBonusList(); openModal(bonusModal); });
      ...
      row.innerHTML = `
        <div class="wow-levelLeft">
          ...
          <div>
            ...
            <div class="wow-muted">Буквы: ${lvl.letters}</div>
          </div>
        </div>
  ...
  function attachWheelHandlers(wheel, nodes) {
    ...
    function hitTest(clientX, clientY) {
      ...
      // 2) Fallback: nearest center within radius (reliable when finger moves fast)
